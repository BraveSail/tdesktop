...
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Mizugram.MizugramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Mizugram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Mizugram Desktop/Mizugram.lnk"_q;
